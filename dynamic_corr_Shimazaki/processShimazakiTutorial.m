% Do analysis of speech spike rasters from reservoir
...
load('speechReservoirShimazaki.mat','raw');
...
data.model.struct.N =10;        %Number of neurons.
data.model.struct.D = 0.001;    %Bin size [s] to make binary data.
data.model.struct.n = 20;      %Number of repeated trials for analysis.
data.model.struct.R = [1 2];  %The order of interactions in the model.
